...
let libroUno = {
    ...
    id: 123,
    genero: "NOVELA",
    descripcion: "  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti fug."
}
let libroDos = {
            ...
            <div v-for="(libro, id) in libros">
                <div class="card" style="width: 18rem; ">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-success" @click="seleccionar(id)" href="">VER LIBRO</button>
                    </div>
                </div>
